# MODEL m15_4M_01 application - MAIN
...
import m15_4M_01_04_plotting_saving_data
...
# DATA LOADING
# data preperation
inp_swl, inp_p, inp_et, inp_w_5, inp_w_6 = m15_4M_01_02_data_loading.Data_Preperation(data, count_data)

# data loading
dataset = m15_4M_01_02_data_loading.Load_Data(inp_swl, inp_p, inp_et, inp_w_5, inp_w_6, in_p, in_et, in_swl, in_w5, in_w6, in_p_forecast, in_et_forecast, in_w_forcecast, forecast_horizon, batch_size)
...
forecast = m15_4M_01_04_plotting_saving_data.Denormalization(hold_lstm_output, swl_max, swl_min)

m15_4M_01_04_plotting_saving_data.Safe_Data(hold_inp_tensor, hold_lstm_output, forecast)
print(forecast)
m15_4M_01_04_plotting_saving_data.Prediction(forecast, 'forecast')
