# MODEL m15_4M_01 application - DATA LOADING
...
def Data_Preperation(data,count_data):
	...
	inp_w_5 = data['Entnahmerate_w_5  [l/s]'].to_numpy()
	inp_w_6 = data['Entnahmerate_w_6  [l/s]'].to_numpy()
	...
	return inp_swl, inp_p, inp_et, inp_w_5, inp_w_6

# data loading
class Load_Data(Dataset):
	def __init__(self, inp_swl, inp_p, inp_et, inp_w5, inp_w6, in_p, in_et, in_swl, in_w5, in_w6, in_p_forecast, in_et_forecast, in_w_forcecast, forecast_horizon, batch_size):
