...
class Load_Data(Dataset):
	def __init__(self, inp_swl, inp_p, inp_et, inp_w5, inp_w6, tar_swl, in_p, in_et, in_swl, in_w5, in_w6, in_p_forecast, in_et_forecast, in_w_forcecast, forecast_horizon):
	...
	def __getitem__(self, idx):
		...
		inp_w5 = self.inp_w5[idx : idx + self.in_w5 + self.in_w_forcecast]
		inp_w6 = self.inp_w6[idx : idx + self.in_w6 + self.in_w_forcecast]
		inputs = np.concatenate([inp_swl, inp_p, inp_et, inp_w5, inp_w6])
